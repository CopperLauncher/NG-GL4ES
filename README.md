...
**Krypton Wrapper** *(aka NG-GL4ES)* is a fork from [gl4es](https://github.com/ptitSeb/gl4es) and [gl4es-114-extra](https://github.com/PojavLauncherTeam/gl4es-114-extra). 
...
Please see [Releases](https://github.com/BZLZHH/NG-GL4ES/releases)
...
License file: [LICENSE](https://github.com/BZLZHH/NG-GL4ES/blob/main/LICENSE).
...
~~**PojavLauncherTeam (gl4es-114-extra)**: [patreon](https://patreon.com/pojavlauncher)~~ (Discontinued)
